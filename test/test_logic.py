...
from ..logic import DPS, can_deal_damage
...
class TestTyrianData(TyrianTestBase):
    ...
    def test_sideways_dps_logic(self) -> None:
        ...
        sideways_dps_check = can_deal_damage(self.multiworld.state, self.player, damage_tables, dps_test_setups[0])
        ...
        sideways_dps_check = can_deal_damage(self.multiworld.state, self.player, damage_tables, dps_test_setups[1])
    ...
    def test_mixed_dps_logic(self) -> None:
        ...
        passive_dps_check = can_deal_damage(self.multiworld.state, self.player, damage_tables, dps_test_setups[1])
        ...
        mixed_dps_check = can_deal_damage(self.multiworld.state, self.player, damage_tables, dps_test_setups[2])
        ...
        mixed_dps_check = can_deal_damage(self.multiworld.state, self.player, damage_tables, dps_test_setups[3])
