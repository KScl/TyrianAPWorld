...
class LevelLocationData:
    ...
    level_regions: Dict[str, LevelRegion] = {
        ...
        "HOLES (Episode 1)": LevelRegion(base_id=20, locations={
            ...
            "HOLES (Episode 1) - U-Ship Formation 2": RequirementList(["Power3"]),
            ...
            "HOLES (Episode 1) - Before Speed Up Section": RequirementList(["Power3", "SideDefensive"]),
        ...
        }, completion_reqs=RequirementList(["Power4"], ["AnyHighDPS", "Power2"], ["SideDefensive", "Power2"]) ),
        ...
        "GYGES (Episode 2)": LevelRegion(base_id=170, locations={
            ...
            "GYGES (Episode 2) - GEM WAR Orb": None, # Needs conditions
        ...
        "ASTCITY (Episode 2)": LevelRegion(base_id=190, locations={
            ...
            "ASTCITY (Episode 2) - MISTAKES Orb": None, # Needs conditions
